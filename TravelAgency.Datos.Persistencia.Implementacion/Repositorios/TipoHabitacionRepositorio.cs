...
{
    public class TipoHabitacionRepositorio : RepositorioBase<TipoHabitacion>, ITipoHabitacionRepositorio
    {
        public TipoHabitacionRepositorio(IContextoUnidadTrabajo contextoUnidadTrabajo) : base(contextoUnidadTrabajo) { }
    }
}
