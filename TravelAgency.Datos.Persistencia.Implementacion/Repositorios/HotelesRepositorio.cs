...
{
    public class HotelesRepositorio : RepositorioBase<Hoteles>, IHotelesRepositorio
    {
        public HotelesRepositorio(IContextoUnidadTrabajo contextoUnidadTrabajo) : base(contextoUnidadTrabajo) { }
    }
}
